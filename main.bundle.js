...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.authenticate = function (username, password) {
        ...
        var body = { "username": "test123@example.com", "password": "123456789" };
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]({ 'Content-Type': 'application/json' });
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* RequestOptions */]({ headers: headers });
        this.http
            .post('http://46.38.242.27:8082/api/login', body, options)
            .map(function (response) { return response.json(); })
            .subscribe(function (response) { return console.log(response); }, function (error) { return _this.errorMessage = error; });
    };
